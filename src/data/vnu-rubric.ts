    ...
    items: [
      {
        ...
        label: 'Tính đầy đủ',
        description:
          'Có đủ trang giới thiệu (có ảnh chân dung/logo VNU-UMP), các trang nhiệm vụ (1–6) và trang tổng kết.',
      },
      {
        id: 's1-2',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Có phần mô tả giải thích tại sao cấu trúc này giúp quản lý hàng trăm tài liệu y dược hiệu quả, tránh nhầm lẫn liều lượng hay phác đồ.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Kết quả tìm kiếm từ các nguồn uy tín như PubMed, VNU-LIC hoặc các tổ chức y tế lớn.',
      },
      {
        id: 's3-3',
        label: 'Phân tích CRAAP',
        description:
          'Phân tích sâu sắc về chiến lược tìm kiếm và thẩm định một bài báo Dược khoa cụ thể (tính cập nhật, độ chính xác…).',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          'Sử dụng mô hình CLEAR (Bối cảnh — Vai trò — Chỉ dẫn — Đối tượng — Tinh chỉnh) cho các tác vụ dược lý.',
      },
      {
        id: 's4-2',
        label: 'Kỹ thuật nâng cao',
        description:
          'Có minh chứng áp dụng Chain-of-Thought (CoT) — yêu cầu AI suy luận từng bước cho một ca lâm sàng.',
      },
      {
        id: 's4-3',
        label: 'So sánh cơ chế',
        description:
          'Phân tích sâu sắc sự khác biệt giữa các mô hình AI (như ChatGPT vs Perplexity) về khả năng trích dẫn y khoa và độ tin cậy.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          'Sản phẩm (Infographic Dược, Video tư vấn thuốc…) có thiết kế sáng tạo, chuyên nghiệp, không lỗi kỹ thuật.',
      },
      {
        id: 's6-2',
    ...
    items: [
      {
        ...
        description:
          '5–7 nguyên tắc chi tiết (ví dụ: luôn kiểm chứng liều lượng từ Dược thư quốc gia sau khi dùng AI).',
      },
      {
        id: 's7-2',
        label: 'Tư duy phản biện',
        description:
          'Phân tích sâu sắc ranh giới giữa "Hỗ trợ" và "Gian lận" trong đào tạo Dược.',
      },
      {
        id: 's7-3',
        label: 'Giải pháp đạo đức',
        description:
          'Đề xuất cách ứng phó với ảo giác AI và bảo vệ dữ liệu bệnh nhân theo Nghị định 13/2023/NĐ-CP.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Mô tả kế hoạch cụ thể để áp dụng các kỹ năng số vào thực tập tại bệnh viện hoặc nghiên cứu Dược lâm sàng sau này.',
      },
    ],
  },
];
...
/** Mục nhiệm vụ theo chỉ số bài 0–5 → mục 2–7 */
...
/** Số thứ tự mục Rubric (1–8) theo section id */
