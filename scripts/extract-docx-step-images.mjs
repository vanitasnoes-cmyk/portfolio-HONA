...
const LESSONS = {
  bt1: { docx: 'Bài 1 Hoàn.docx', stepCount: 12 },
  bt2: { docx: 'Bài 2 Hoàn.docx', stepCount: 11 },
  bt3: { docx: 'Bài 3 Hoàn.docx', stepCount: 10 },
  bt4: { docx: 'Bài 4 Hoàn.docx', stepCount: 11 },
  bt5: { docx: 'bài 5 hoàn.docx', stepCount: 10 },
  bt6: { docx: 'Bài 6 Hoàn.docx', stepCount: 10 },
};
...
function mapByHeadline(blocks, stepTexts, stepCount) {
  ...
  for (const block of blocks) {
    ...
    if (block.embeds.length > 0 && currentStep >= 0) {
