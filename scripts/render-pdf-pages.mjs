...
const pdfs = [
  { prefix: 'bt1', file: 'BT1_Chuong1_LuuDucAnh.pdf' },
  { prefix: 'bt2', file: 'BT2_Chuong2_LuuDucAnh.pdf' },
  { prefix: 'bt3', file: 'BT2_Chuong3_LuuDucAnh.pdf' },
  { prefix: 'bt4', file: 'BT3_Chuong4_LuuDucAnh.pdf' },
  { prefix: 'bt5', file: 'BT2_Chuong5_LuuDucAnh.pdf' },
  { prefix: 'bt6', file: 'BT4_Chuong6_LuuDucAnh.pdf' },
];
